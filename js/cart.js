import { catalogList, countAmount, modalProductBtn, orderCount, orderList, orderTotalAamount, orderWrapTitle, order, orderSubmit, modalDelivery, modalDeliveryContainer, Thanks} from "./elements.js";
...
export const renderCartList = async () => {
    ...
    orderTotalAamount.textContent = data.reduce((acc, item) => {
        const product = cartList.find((cartItem => cartItem.id === item.id));
